...
HD_PWD='C:/Users/JEFF/MICROBLAZE_V_AXI/MICROBLAZE_V_AXI.runs/design_1_microblaze_riscv_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_microblaze_riscv_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_microblaze_riscv_0_axi_intc_0.tcl
